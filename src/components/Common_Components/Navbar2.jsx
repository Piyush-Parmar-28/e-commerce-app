    ...
    return (
        <div className="my-navbar d-flex justify-content-between align-items-center">
            ...
            <div className="d-flex">
                ...
                {status && <div className="d-flex justify-content-center align-items-center me-2">
                    <label className="me-1" id="cart">
                        <b>Cart</b>
                    </label>
                ...
                {status && <div className="d-flex justify-content-center align-items-center ms-2">
                    ...
                    >
                        <Link to="/profile" className="text-decoration-none">
                            <p className="dropdown-item text-black">Profile</p>
                        </Link>

                        <Link to="/cart" className="text-decoration-none">
                            <p className="dropdown-item text-black">Cart</p>
                        </Link>
